...
Run (resolution-parametrized CLI; NU graded mesh keeps cells bounded):
  ...
  JAX_PLATFORMS=cpu python scripts/research/calibration/crossval/rfx_patch_s11_convergence.py \
      --dx-fine-list-mm 0.5
  # GPU high-res sweep (VESSL): just change the list
  python scripts/research/calibration/crossval/rfx_patch_s11_convergence.py \
      --dx-fine-list-mm 0.5,0.33,0.25,0.2 --output scripts/research/calibration/crossval/out
