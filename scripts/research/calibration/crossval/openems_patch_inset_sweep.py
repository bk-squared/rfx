...
the deepest null near the ~2.4-2.5 GHz resonance. Emits:
  * scripts/research/calibration/crossval/out_ref/openems_patch_inset_sweep.json  (full sweep)
  * scripts/research/calibration/crossval/out_ref/openems_patch_matched.json      (best y0)
  * scripts/research/calibration/crossval/matched_patch_geometry.json             (geometry spec)

Run (system python — openEMS / CSXCAD bindings live there):
  python scripts/research/calibration/crossval/openems_patch_inset_sweep.py
"""
