...
Usage:
  ...
  python3 check_sparams.py postpro/sheen_full_4090/port-S.csv --summary   # first-null verdict summary
"""
import csv
import math
import sys
...
def main():
    ...
    if mode == "--gate":
        ...
        if worst > 1.02:
            print("REFEREE-INVALID: probe violates passivity (>1.02) -- STOP per referee falsifier")
            sys.exit(3)
