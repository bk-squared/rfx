...
modal transfer-map target-basis orientation residual phase/sign implementation
after the private failure-theory contract selected a bounded next target.
