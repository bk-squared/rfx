...
implementation after failure-theory contract ready. The preceding
failure-theory lane records
...
R/T readiness, and threshold promotion closed while selecting only a private
score-path visibility contract.
