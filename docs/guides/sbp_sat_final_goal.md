...
pairing packet-basis phase-energy cross-coupling score-path visibility parity
scoring after implementation hunk retained. The preceding implementation
lane records
...
R/T readiness, and threshold promotion closed while retaining only a private
score-path visibility helper for the next private parity score.
