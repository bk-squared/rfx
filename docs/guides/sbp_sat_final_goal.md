...
field-update coupling implementation after the failure-theory contract became
ready. The preceding failure-theory lane records
...
private score-path visibility field-update coupling floor.
