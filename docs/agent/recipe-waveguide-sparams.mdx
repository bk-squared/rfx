...
369367258638) — with criterion 1 (forward identity) and 3(a) (AD-vs-FD) read
under x64 on the `normalize="flux"` lane, the forward default still float32.
...
chain-closed as "supported" — that is a v2.0 word.
