...
| **Studio and versioned CPU experiments** | local spec-first workflow with immutable revisions, preflight, durable runs, replay bundles, and approval-gated MCP |
...
- [Studio and Durable Experiments](guide/studio-experiments/) — local UI, versioned CPU runs, replay, and MCP approvals
