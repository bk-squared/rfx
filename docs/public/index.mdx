...
| **Port-family evidence envelopes** | rectangular-waveguide S-matrices and coaxial transmission-line reflection via the documented calculators | claims-bearing only inside the support-matrix envelope; not a universal port guarantee |
| **Experimental / under active validation** | distributed execution, Floquet/Bloch workflows, general SBP-SAT subgridding, generalized planar/advanced ports, and inverse-design extensions | useful for experiments; check current limitations |
...
| **Shadow / experimental lanes** | non-uniform mesh is shadow; distributed runs, Floquet/Bloch, general SBP-SAT subgridding, generalized planar ports, and broad inverse-design extensions remain lane-scoped |
...
- [Sources & Ports](guide/sources-ports/) — point sources, lumped/wire ports, waveguide ports, coaxial-line reflection, and experimental Floquet surfaces
