...
Start from the [Recommended Configuration](/rfx/validation/recommended-configuration/), then
read [Support Boundaries](/rfx/api/support-boundaries/) for the exact mesh,
source, port, calculator, and observable restrictions.
