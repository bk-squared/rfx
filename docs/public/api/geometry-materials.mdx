...
Geometry and materials are part of the validated reference lane only when
they are paired with a supported boundary / source / observable combination.
If a structure depends on a limited-support path, the public docs should say so
explicitly.
