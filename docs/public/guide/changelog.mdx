...
- Current examples are routed through maintained paths: `examples/crossval/05_patch_antenna.py`, `examples/crossval/11_waveguide_port_wr90.py`, `examples/tutorials/nonuniform_patch_demo.py`, and `examples/inverse_design/multilayer_ar_coating.py`.
