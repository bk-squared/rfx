...
The following features are useful, but should be treated as experimental or under active validation:
...
Lead public messaging with the recommended uniform Yee RF lane. Mention experimental lanes only when the user specifically needs them, and keep those descriptions scoped to current examples and limitations.
