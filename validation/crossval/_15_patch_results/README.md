...
from 2026-08-29 and has been stale against the committed solver since 2026-08-31. The
#812 round-1 lane measured this (it regenerated the leg to −0.3448 dB) and then reverted
the regeneration; see the appended 2026-09-06 section of
`docs/design_notes/20260901_numeric_provenance_gate.md`.
