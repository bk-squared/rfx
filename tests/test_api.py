...
@pytest.mark.skip(
    reason=(
        ...
        "PEC-folded per-port straight-guide references through the pre-existing "
        "extract_waveguide_s_matrix_flux(ref_materials_per_port=...) arg (the "
        "public compute_waveguide_s_matrix port_reference_materials plumbing was "
        "NOT shipped) is "
        "NECESSARY but NOT SUFFICIENT — it fixes |S11| (1.9->0.49, physical) and "
