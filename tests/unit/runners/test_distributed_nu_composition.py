"""
tests/unit/runners/test_distributed_nu_composition.py
...
``tests/unit/runners/test_distributed_nu_kernel.py::test_distributed_cpml_internal_seam_is_noop``).
...
def test_forward_distributed_cpml_two_device_matches_single_device_small_case():
    ...
    the kernel level by tests/unit/runners/test_distributed_nu_kernel.py::
...
# kernel level by tests/unit/runners/test_distributed_nu_kernel.py::
