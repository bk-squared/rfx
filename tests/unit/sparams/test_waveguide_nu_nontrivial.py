...
``tests/unit/sparams/test_waveguide_nu_flux.py`` (CPU sanity + Airy accuracy) and the
...
The air-thru test (tests/unit/sparams/test_waveguide_nu_sparam.py) only validates the
