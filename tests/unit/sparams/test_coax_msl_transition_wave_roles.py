...
# ---------------------------------------------------------------------------
# Attempt-3 plane geometry (tests/unit/sparams/test_coax_msl_transition.py, DX = 100 um):
...
def _plant_ab_signal_flow(s, gamma_t):
    ...
    ``tests/unit/sparams/test_coax_msl_transition.py::_plant_ab_power_wave``): unit
