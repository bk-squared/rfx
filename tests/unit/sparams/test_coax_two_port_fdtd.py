...
def _plant_ab(s_true, gamma_t, n_f):
    ...
    ``tests/unit/sparams/test_coax_two_port_solve.py::_plant`` (same convention:
...
def test_matched_through_line_transmits_reciprocally():
    ...
    # calibration's own gate (tests/unit/sparams/test_coaxial_line_calibration.py),
    ...
    # matched-termination envelope (tests/unit/sparams/test_coaxial_line_calibration.py,
