...
def _preflight_text(sim):
    ...
    stdout is the surface (same as tests/unit/nonuniform/test_nonuniform_source_port_dual_
...
def _capture(sim):
    ...
    Same monkeypatch-spy pattern tests/unit/nonuniform/test_nonuniform_source_port_dual_spacing
