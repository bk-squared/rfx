...
``tests/unit/materials/test_sheet_impedance_operator.py::test_g9_refusal_helper_message_names_the_lane``,
...
FENCE_REGISTRY: dict[tuple[str, str, str], tuple[str, str]] = {
    ...
    ("rfx/runners/distributed.py", "run_distributed", "distributed (v1) runner"):
        ("tests.unit.materials.test_sheet_impedance_operator",
    ...
    ("rfx/runners/uniform.py", "run_uniform", "boundary='upml'"):
        ("tests.unit.materials.test_sheet_impedance_operator", "test_g9_upml_refuses"),
    ...
    ("rfx/vmap_sweep.py", "_build_full_scan_fn", "has_f0_sheets"):
        ("tests.unit.materials.test_leontovich_sheet_identity",
         "test_vmap_parity_o7"),
}
