...
# ---------------------------------------------------------------------------
# Shared fixture -- same geometry family as tests/unit/autodiff/test_observables_dft_field.py
...
def test_g6a_distributed_nu_dft_plane_fence_raises():
    ...
    tests/unit/autodiff/test_observables_dft_field.py::test_forward_distributed_nu_dft_planes_fence_raises."""
    nx, ny, nz = 16, 12, 12
    dx = 1e-3
    sim = Simulation(
...
def test_g6b_n_warmup_fence_raises():
    ...
    tests/unit/autodiff/test_n_warmup.py::test_uniform_forward_rejects_n_warmup for the
