...
Mirror of ``tests/unit/autodiff/test_waveguide_flux_ad.py`` (the uniform PR #172 flux-AD
...
def _wr90_nu_sim():
    ...
    Same geometry as ``tests/unit/sparams/test_waveguide_nu_flux.py`` so the fixture is
