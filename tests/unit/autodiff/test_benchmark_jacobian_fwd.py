...
Precedent: tests/unit/autodiff/test_memory_reduction_planning_artifact.py /
tests/unit/autodiff/test_estimate_ad_memory.py -- assert RATIOS/RELATIONS between
...
tests/unit/autodiff/test_jacobian_fwd.py (it inspects the jaxpr directly for one
