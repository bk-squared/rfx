...
AD_CLASSIFICATION = {
    ...
    "Simulation.compute_waveguide_s_matrix": (
        GRAD_SAFE,
        "tests/unit/autodiff/test_sparam_ad_end_to_end.py::test_waveguide_s_matrix_ad_end_to_end, "
        "tests/unit/autodiff/test_waveguide_sparam_ad.py::test_wg_smatrix_assembly_ad_traceable",
    ),
    "Simulation.compute_msl_s_matrix": (
        ...
        "tests/unit/autodiff/test_sparam_ad_end_to_end.py::test_msl_s_matrix_ad_end_to_end",
    ),
    ...
    "Simulation.compute_coaxial_line_reflection": (
        ...
        "tests/unit/autodiff/test_coax_end_to_end_ad.py::test_coax_reflection_grad_finite_and_fd_consistent",
    ),
    ...
    "compute_far_field_jax": (
        GRAD_SAFE,
        "tests/unit/autodiff/test_directivity_gradient.py::test_maximize_directivity_gradient_nonzero",
    ),
    "compute_rcs": (
        NOT_TRACEABLE,
    ...
    "compute_rcs_jax": (
        ...
        "tests/unit/autodiff/test_rcs_jax_differentiable.py::test_rcs_jax_gradient_fd_convergence",
    ),
    "compute_floquet_s_params": (
        GRAD_SAFE,
        "first real pytest caller + finite-grad smoke (issue #141): "
        "tests/unit/ports/test_floquet_s_params_contract.py::test_compute_floquet_s_params_grad_finite, "
        "tests/unit/ports/test_floquet_s_params_contract.py::test_compute_floquet_s_params_real_fdtd_runs — "
    ...
    "extract_floquet_modes": (
        ...
        "tests/unit/ports/test_floquet_s_params_contract.py::test_extract_floquet_modes_grad_finite — "
        "https://github.com/bk-squared/rfx/issues/141",
    ),
    ...
    "extract_s_matrix_wire": (
        ...
        "forward(port_s11_freqs=...) — tests/unit/sparams/test_wire_port_sparams_forward.py",
    ),
    ...
    "observables.dft_field": (
        ...
        "tests/unit/autodiff/test_observables_dft_field.py::test_field_energy_material_leg_ad_matches_fd, "
        "tests/unit/autodiff/test_observables_dft_field.py::test_field_energy_geometry_leg_ad_matches_fd",
    ),
    ...
    "observables.field_softmax": (
        ...
        "tests/unit/autodiff/test_observables_dft_field.py::test_field_softmax_material_leg_ad_matches_fd, "
        "tests/unit/autodiff/test_observables_dft_field.py::test_field_softmax_geometry_leg_ad_matches_fd",
    ),
    "observables.jacobian_fwd": (
        ...
        "tests/unit/autodiff/test_jacobian_fwd.py::test_g1_material_and_geometry_legs_ad_matches_fd, "
        "tests/unit/autodiff/test_jacobian_fwd.py::test_g1_many_output_tensor_leg_ad_matches_fd — "
        "severed-tape falsifier confirmed the gate reads exactly 0.0 AD vs "
        "finite FD when eps_override is stop_gradient'd: "
        "tests/unit/autodiff/test_jacobian_fwd.py::test_g7_falsifier_severed_tape_reads_exactly_zero.",
    ),
}
