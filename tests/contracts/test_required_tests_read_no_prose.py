...
DOCS_CONSISTENCY_TESTS = frozenset({
    ...
    "tests/contracts/test_crossval_manifest_contract.py::test_public_validation_docs_match_manifest",
    "tests/contracts/test_crossval_manifest_contract.py::test_repo_map_defers_crossval_claims_to_manifest",
    ...
    "tests/crossval/test_crossval_cv15_wall_planes.py::test_cv15_current_measurement_prose_follows_committed_legs",
