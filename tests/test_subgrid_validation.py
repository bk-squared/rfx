...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("material_sat_e_h_trace_zlo_blend", 0.75),
        ("material_sat_e_h_trace_zhi_blend", 0.75),
        ("material_sat_e_h_trace_zlo_filter", "mean_delta"),
        ("material_sat_e_h_trace_zlo_components", "hx"),
        ("material_sat_e_h_trace_zlo_vector_mix", "swap"),
        ("material_sat_e_h_trace_zlo_residual_limit", 0.75),
        ...
        ("box_shadow_sync_region", "faces"),
        ("box_shadow_sync_scale", 0.75),
        ("box_shadow_sync_face_axes", "xy"),
        ("box_shadow_sync_components", "ez"),
        ("box_shadow_sync_face_sides", "xlo_yhi"),
        ("box_shadow_sync_timing", "post_h_only"),
