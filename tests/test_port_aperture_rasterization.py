...
def _sub_aperture_sim(freqs, f0=5.5e9):
    ...
    tests/test_waveguide_port_reference_sims.py::_tj_device's straight
...
_CASES = [
    ...
    # (tests/test_waveguide_port_reference_sims.py, tests/test_api.py,
    # tests/test_distributed.py) and it was the table's blind spot -- the
