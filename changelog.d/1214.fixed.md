### Fixed — a dispersive model split across devices no longer builds the whole domain's Debye/Lorentz arrays on the first device; Kerr materials are refused on that lane instead of running linear (#1214)
